...
void DrawPlaneBody(const float width, const float length, const float height, const float clength)
{
    ...
    //////////////////////////////////////////////////////////
    glBegin(GL_QUADS);
    glColor3f(0.5f, 0.5f, 0.5f); //back copter 2nd fan right back
    ...
    glBegin(GL_QUADS);
    glColor3f(0.5f, 0.5f, 0.5f); //back copter 2nd fan right front
    ...
    glColor3f(0.0f, 0.8f, 0.8f); //cockpit top
    glVertex3f(w * 0.5, 0.25 + h, l * 0.5);
    glVertex3f(w * 0.5, 0.25 + h, -l * 0.5);
    glVertex3f(-w * 0.5, 0.25 + h, -l * 0.5);
    glVertex3f(-w * 0.5, 0.25 + h, l * 0.5);

    glColor3f(0.0f, 0.8f, 0.8f); //cockpit bottm
    glVertex3f(-w * 0.5, h, l * 0.5);
    glVertex3f(-w * 0.5, h, -l * 0.5);
    glVertex3f(w * 0.5, h, -l * 0.5);
    glVertex3f(w * 0.5, h, l * 0.5);

    glColor3f(0.0f, 0.8f, 0.8f); //cockpit front
    glVertex3f(-w * 0.5, 0.25 + h, l * 0.5);
    glVertex3f(w * 0.5, 0.25 + h, l * 0.5);
    glVertex3f(w * 0.5, h, l * 0.5);
    glVertex3f(-w * 0.5, h, l * 0.5);

    glColor3f(0.0f, 0.8f, 0.8f); //cockpit back
    glVertex3f(-w * 0.5, 0.25 + h, -l * 0.5);
    glVertex3f(-w * 0.5, h, -l * 0.5);
    glVertex3f(w * 0.5, h, -l * 0.5);
    glVertex3f(w * 0.5, 0.25 + h, -l * 0.5);

    glColor3f(0.0f, 0.5f, 1.0f); //cockpit left
    glVertex3f(-w * 0.5, h, l * 0.5);
    glVertex3f(-w * 0.5, 0.25 + h, l * 0.5);
    glVertex3f(-w * 0.5, 0.25 + h, -l * 0.5);
    glVertex3f(-w * 0.5, h, -l * 0.5);

    glColor3f(0.0f, 0.5f, 1.0f); //cockpit right
    glVertex3f(w * 0.5, h, l * 0.5);
    glVertex3f(w * 0.5, 0.25 + h, l * 0.5);
    glVertex3f(w * 0.5, 0.25 + h, -l * 0.5);
    glVertex3f(w * 0.5, h, -l * 0.5);
    ...
    glColor3f(0.0f, 0.0f, 1.0f); //right outer bellow
    glVertex3f(2 * w, -h, l);
    glVertex3f(2 * w, -h, -l);
    glVertex3f(2 * w, h, -l);

    glColor3f(0.0f, 0.0f, 1.0f); //Left outer bellow
    glVertex3f(2 * -w, -h, l);
    glVertex3f(2 * -w, -h, -l);
    glVertex3f(2 * -w, h, -l);


    glColor3f(0.0f, 0.0f, 1.0f); //tail
    glVertex3f(0.75 * -w, -h, 0.5 * 5);
    glVertex3f(0.75 * -w, -h, 0.1 * -5);
    glVertex3f(0.75 * -w, 3 * h, 0.5 * -5);
...
void DrawPropeller(const float width, const float length) //Landing gear, instead
{
    ...
    glBegin(GL_QUADS);
    glColor3f(3.0f, 1.0f, 0.0f); //top
    glVertex3f(w, l, 0.5 / 3);
    glVertex3f(w, l, -0.5 / 3);
    glVertex3f(-w, l, -0.5 / 3);
    glVertex3f(-w, l, 0.5 / 3);

    glColor3f(2.0f, 1.0f, 0.0f); //bottom
    glVertex3f(-w, -l, 0.5 / 3);
    glVertex3f(-w, -l, -0.5 / 3);
    glVertex3f(w, -l, -0.5 / 3);
    glVertex3f(w, -l, 0.5 / 3);

    glColor3f(2.5f, 1.0f, 1.0f);  //front
    glVertex3f(-w, -l, 0.5 / 3);
    glVertex3f(w, -l, 0.5 / 3);
    glVertex3f(w, l, 0.5 / 3);
    glVertex3f(-w, l, 0.5 / 3);

    glColor3f(3.5f, 1.0f, 1.0f); //back
    glVertex3f(-w, -l, -0.5 / 3);
    glVertex3f(-w, l, -0.5 / 3);
    glVertex3f(w, l, -0.5 / 3);
    glVertex3f(w, -l, -0.5 / 3);

    glColor3f(1.5f, 0.0f, 0.0f); //left
    glVertex3f(-w, -l, 0.5 / 3);
    glVertex3f(-w, l, 0.5 / 3);
    glVertex3f(-w, l, -0.5 / 3);
    glVertex3f(-w, -l, -0.5 / 3);

    glColor3f(2.0f, 0.0f, 0.0f); //right
    glVertex3f(w, -l, 0.5 / 3);
    glVertex3f(w, -l, -0.5 / 3);
    glVertex3f(w, l, -0.5 / 3);
    glVertex3f(w, l, 0.5 / 3);
    ...
    glColor3f(1.0f, .0f, 1.0f);  //front
    glVertex3f(-0.25, -l - 0.25, 0.25);
    glVertex3f(0.25, -l - 0.25, 0.25);
    glVertex3f(0.25, -l, 0.25);
    glVertex3f(-0.25, -l, 0.25);

    glColor3f(1.0f, 5.0f, 1.0f); //back
    glVertex3f(-0.25, -l - 0.25, -0.25);
    glVertex3f(-0.25, -l, -0.25);
    glVertex3f(0.25, -l, -0.25);
    glVertex3f(0.25, -l - 0.25, -0.25);
