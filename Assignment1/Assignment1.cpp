    ...
    int x2, int y2, int r2, int g2, int b2)
{
    ...
    float l03_y, l03_m; // add this
    float l03_r, l03_g, l03_b, l03_mr, l03_mg, l03_mb; // add this
    int x;
    ...
    l03_m = (float)(y2 - y1) / (x2 - x1); // add this
    l03_mr = (float)(r2 - r1) / (x2 - x1); // add this
    l03_mg = (float)(g2 - g1) / (x2 - x1); // add this
    l03_mb = (float)(b2 - b1) / (x2 - x1); // add this
